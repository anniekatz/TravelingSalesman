...
class Package:
    ...
    def __str__(self):
        return "Package ID: " + self.id + " | Address: " + self.address + " | City: " + self.city + " | State: " + self.state + " | Zip: " + self.zipcode + " | Deadline: " + self.deadline + " | Departure Time: " + str(self.departure_dt)

    # get status of package for user interface
